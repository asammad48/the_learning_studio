const subjects = [
  ...
  { title: 'Computer Science', category: 'Technology & Computer Science', lessons: 30, description: 'Algorithms, systems and software thinking for modern learners.', href: 'index.html#subjects' },
  { title: 'Web Development', category: 'Technology & Computer Science', lessons: 26, description: 'Build responsive websites with HTML, CSS and JavaScript.', href: 'index.html#subjects' },
  { title: 'Cybersecurity', category: 'Technology & Computer Science', lessons: 19, description: 'Protect systems, people and data from common threats.', href: 'index.html#subjects' },
  { title: 'Cloud Computing', category: 'Technology & Computer Science', lessons: 17, description: 'Deploy scalable apps and services with modern cloud tools.', href: 'index.html#subjects' },
  { title: 'Finance Basics', category: 'Finance & Accounting', lessons: 19, description: 'Budgets, markets, cash flow and financial decision making.', href: 'index.html#subjects' },
  { title: 'Accounting', category: 'Finance & Accounting', lessons: 21, description: 'Records, statements and the language of business performance.', href: 'index.html#subjects' },
  { title: 'Investing', category: 'Finance & Accounting', lessons: 15, description: 'Risk, return, diversification and long-term planning.', href: 'index.html#subjects' },
  { title: 'Digital Marketing', category: 'Marketing & Digital Skills', lessons: 17, description: 'Campaigns, channels and measurement for online growth.', href: 'index.html#subjects' },
  { title: 'Content Strategy', category: 'Marketing & Digital Skills', lessons: 13, description: 'Plan useful content that reaches the right audience.', href: 'index.html#subjects' },
  { title: 'Personal Branding', category: 'Marketing & Digital Skills', lessons: 12, description: 'Communicate your value with clarity and consistency.', href: 'index.html#subjects' },
  { title: 'Psychology', category: 'Psychology & Education', lessons: 16, description: 'Behavior, learning, memory and human development.', href: 'index.html#subjects' },
  { title: 'Instructional Design', category: 'Psychology & Education', lessons: 14, description: 'Create lessons, activities and assessments that work.', href: 'index.html#subjects' },
  { title: 'Learning Science', category: 'Psychology & Education', lessons: 15, description: 'Evidence-based approaches to study, practice and recall.', href: 'index.html#subjects' },
  { title: 'Supply Chain', category: 'Supply Chain & Operations', lessons: 15, description: 'Move products, information and value through reliable systems.', href: 'index.html#subjects' },
  { title: 'Operations Management', category: 'Supply Chain & Operations', lessons: 18, description: 'Improve processes, quality and capacity across teams.', href: 'index.html#subjects' },
  { title: 'Logistics', category: 'Supply Chain & Operations', lessons: 12, description: 'Coordinate transportation, warehousing and delivery.', href: 'index.html#subjects' },
  { title: 'Health Science', category: 'Health & Medical', lessons: 14, description: 'Foundations of health, care systems and medical terminology.', href: 'index.html#subjects' },
  { title: 'Public Health', category: 'Health & Medical', lessons: 13, description: 'Understand prevention, populations and community health.', href: 'index.html#subjects' }
];
